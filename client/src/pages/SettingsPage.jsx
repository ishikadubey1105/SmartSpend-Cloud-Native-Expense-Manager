    ...
    return (
        <div style={{ maxWidth: 720 }}>
            <div className="mb-6">
                ...
                <p className="text-secondary text-sm mt-2">Manage your account and preferences</p>
            </div>
                ...
                <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', marginTop: 'var(--space-4)' }}>
                    ...
                    <div className="grid-2" style={{ gap: 'var(--space-4)' }}>
                        <div className="form-group">
                            ...
                            <p className="text-xs text-muted mt-1">Used for the dashboard budget gauge</p>
                        </div>
                        <div className="form-group">
            ...
            <div className="card animate-in stagger-1">
                <h3 style={{ fontSize: '1rem', marginBottom: 'var(--space-4)' }}>About SmartSpend</h3>
